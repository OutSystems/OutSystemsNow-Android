...
public class ApplicationsAdapter extends ArrayAdapter<Application> {
    ...
    public ApplicationsAdapter(Context context, List<Application> applications) {
        ...
        options = new DisplayImageOptions.Builder().showImageOnLoading(R.drawable.no_app_image)
                .showImageForEmptyUri(R.drawable.no_app_image).showImageOnFail(R.drawable.no_app_image).cacheInMemory(true)
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String url = WebServicesClient.getAbsoluteUrlForImage(HubManagerHelper.getInstance().getApplicationHosted(), application.getImageId());
